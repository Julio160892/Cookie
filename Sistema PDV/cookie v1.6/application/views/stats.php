...
<div id="footer" style="background-color: #093457;width: 100%;">
  <div class="container">
    <p class="footer-block" style="margin: 20px 0;color:#fff;"><?=label('title');?> <?= $this->setting->companyname;?>. <?=label('version');?> <a target="_blank" href="http://www.facebook.com/AnthonCode">AnthonCode</a></p>
  </div>
</div>
