...
class Invoices extends CI_Controller
{
    ...
    {
       // $sales = Sale::find('last');//ultima venta
       // $waiters = Waiter::find($sales->waiter_id);// nombre de cajero //captura id devuelve nombre
...
/********************************/
        ...
        if (intval($sale->discount))
            $ticket .= '<tr>
                            <td style="text-align:left; padding:3px;">' . label("Discount") . '</td>
                            <td style="text-align:right; padding:3px; padding-right:1.5%;font-weight:bold;">' . $sale->discount . '</td>
                        </tr>';
        /*******************************/
        if (intval($sale->tax))
            $ticket .= '<tr>
        <td style="text-align:left; padding:3px; padding-left:1.5%;">' . label("tax") . '</td>
        <td style="text-align:right; padding:3px;font-weight:bold;">' . $sale->tax . '</td>
        </tr>';
